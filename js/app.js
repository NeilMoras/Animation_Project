...
// --FUNCTION THAT WILL FIRE UP THE SECOND SCENE- IT IS TRIGGERS ON THE LAST CLICKK OF THE START SCENE BUTTON --------------------------->
  ...
  function fireUpEverything() {
    ...
    frieza.style.backgroundImage = "url('../NeilJosephPiusMoras_Animation_Project/images/frieza-sprite2-final.png')";
    frieza.classList.add("frieza-fire-launch");
    friezaSpriteBall.classList.add("frieza-fire-ball");
    vegeta.style.backgroundImage = "url('../NeilJosephPiusMoras_Animation_Project/images/vegeta-small.png')";
    ...
    goku.style.backgroundImage = "url('../NeilJosephPiusMoras_Animation_Project/images/goku-1.png')";
...
//--BACKGROUNG IMAGE URL CONTAINS THE FILE PATH FOR OFFLINE VIEWING, IF USING TEXT EDITOR LIVE SERVER THEN USE  JUST EXAMPLE "url('../images/goku-1.png')"; --------------------------->
  ...
  function punch() {
    ...
    goku.style.backgroundImage = "url('../NeilJosephPiusMoras_Animation_Project/images/goku-punch2.png')";
  ...
  function powerUp() {
    goku.classList.remove("goku-second-scene-launch");
    goku.style.backgroundImage = "url('../NeilJosephPiusMoras_Animation_Project/images/goku-fire-btn.png')";
  ...
  function kick() {
    goku.classList.remove("goku-second-scene-launch");
    goku.style.backgroundImage = "url('../NeilJosephPiusMoras_Animation_Project/images/goku-kick-btn.png')";
  ...
  function kamehamey() {
    goku.classList.remove("goku-second-scene-launch");
    goku.style.backgroundImage = "url('../NeilJosephPiusMoras_Animation_Project/images/goku-kame-sprite.png')";
